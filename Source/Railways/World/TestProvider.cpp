...
UMaterialInterface* UTestProvider::GetBoxMaterial() const
{
	FScopeLock Lock(&PropertySyncRoot);
	return Material;
}

void UTestProvider::SetBoxMaterial(UMaterialInterface* InMaterial)
{
	FScopeLock Lock(&PropertySyncRoot);
	Material = InMaterial;
...
FBoxSphereBounds UTestProvider::GetBounds()
{
	return FBoxSphereBounds(FBox(-BoxRadius, BoxRadius));
}

bool UTestProvider::GetSectionMeshForLOD(int32 LODIndex, int32 SectionId, FRuntimeMeshRenderableMeshData& MeshData)
...
//FRuntimeMeshCollisionSettings UTestProvider::GetCollisionSettings()
//{
...
//}
//
//bool UTestProvider::HasCollisionMesh()
//{
//	return true;
//}
//
//bool UTestProvider::GetCollisionMesh(FRuntimeMeshCollisionData& CollisionData)
//{
...
bool UTestProvider::IsThreadSafe()
{
	return true;
}
